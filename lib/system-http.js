...
const { sessionFromRequest } = require('./system-auth.js');
...
function requireSession(req, res, roles = ['owner', 'operator']) {
...
module.exports = { MAX_BODY_BYTES, json, bodyOf, allowedOrigin, requireSession, requestKey };
